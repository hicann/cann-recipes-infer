...
class Infer(nn.Module):
    ...
    def get_inputs(self, prompts, past_key_values, past_key_values_mtp, warm_up):
    ...
    def model_generate(self, prompts, past_key_values=None, past_key_values_mtp=None, warm_up=False):
