...
DEFAULT_ROPE_SCALING = {
    ...
    "mscale": 1.0,
    "mscale_all_dim": 1.0,
    "origin_max_position_embeddings": 65536,
    "type": "yarn",
}
...
class DeepseekV3Config(PretrainedConfig):
    ...
    Args:
        ...
        n_shared_experts (`int`, *optional*, defaults to 1):
            Number of shared experts. This recipe supports one shared expert.
    ...
    def get_config_dict(cls, pretrained_model_name_or_path, **kwargs):
        ...
        if vision_config:
            config_dict.update(
                ...
                vision_n_heads=vision_config["num_attention_heads"],
                vision_inter_dim=vision_config["intermediate_size"],
    ...
    def __init__(
        ...
        engram_num_embeddings=[384008192, 384018432],
        ...
        **kwargs,
        ...
        self.attention_types = ["win" if ratio == 0 else f"c{ratio}a" for ratio in self.compress_ratios]
        ...
        self.quantization_config = kwargs.get('quantization_config', DEFAULT_QUANTIZATION_CONFIG)
        ...
        self.engram_num_embeddings = engram_num_embeddings
