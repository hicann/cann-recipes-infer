...
class WanAttentionBlock(nn.Module):
    ...
    def __init__(self,
        ...
        # layers
        self.norm1 = FusedLayerNormModulate(dim, eps)
        ...
        self.cross_attn = WanCrossAttention(dim, num_heads, (-1, -1), qk_norm,
                                            eps)
        self.norm2 = FusedLayerNormModulate(dim, eps)
...
class Head(nn.Module):
    ...
    def __init__(self, dim, out_dim, patch_size, eps=1e-6):
        ...
        self.norm = FusedLayerNormModulate(dim, eps)
    ...
    def forward(self, x, e):
        ...
        with torch.amp.autocast('npu', dtype=torch.bfloat16):
            ...
            x = self.head(
                    self.norm(x, scale=e[1].squeeze(2), shift=e[0].squeeze(2))
            )
        return x
...
class WanModel(ModelMixin, ConfigMixin):
    ...
    def __init__(self,
        ...
        if model_type not in ['t2v', 'i2v', 'ti2v']:
            raise ValueError(f"model_type must be one of ['t2v', 'i2v', 'ti2v'], got '{model_type}'")
