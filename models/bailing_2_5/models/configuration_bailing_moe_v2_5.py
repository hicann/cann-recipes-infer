# coding=utf-8
# Adapted from
# https://huggingface.co/inclusionAI/Ling-2.5-1T/blob/main/configuration_bailing_moe_v2_5.py
...
class BailingMoeV25Config(PreTrainedConfig):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.moe_topk = num_experts_per_tok
        self.n_routed_experts = num_experts
        self.attention_bias = False
        self.mla_scale_q_lora = True
        self.mla_scale_kv_lora = True
