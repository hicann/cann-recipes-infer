...
## 概述
DeepSeek团队发布了最新的模型DeepSeek-V3.2，在各项指标上都达到了SOTA水平。本样例基于Deepseek开源代码进行迁移，并在CANN平台上完成对应的优化适配，可在华为 Atlas A3 集群上运行起来。

- 本样例的并行策略和性能优化点详细介绍可参见[NPU DeepSeek V3.2推理优化实践](../../docs/models/deepseek-v3.2-exp/deepseek_v3.2_inference_guide.md)。
...
### 下载权重
  ...
  下载[DeepSeek-V3.2原始fp8权重](https://huggingface.co/deepseek-ai/DeepSeek-V3.2-Exp/tree/main)，并上传到Atlas A3各节点某个固定的路径下，比如`/data/models/DeepSeek-V3.2-Exp-fp8`。
