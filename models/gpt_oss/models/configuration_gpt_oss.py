# coding=utf-8
# This code is copied from the gpt_oss implementations.
# (https://github.com/huggingface/transformers/blob/v5.0.0/src/transformers/models/gpt_oss/configuration_gpt_oss.py)
