# coding=utf-8
# This code is copied from the Qwen3_Moe implementations.
# (https://github.com/huggingface/transformers/blob/v5.0.0/src/transformers/models/qwen3_moe/configuration_qwen3_moe.py)
