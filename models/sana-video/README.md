...
2. 安装Ascend Extension for PyTorch（torch_npu）。
   ...
   请从[软件包下载地址](https://gitcode.com/Ascend/pytorch/releases/v7.3.1-pytorch2.6.0)下载`torch_npu-2.6.0.post5-cp310-cp310-manylinux_2_28_${arch}.whl`安装包，并参考[torch_npu安装文档](https://www.hiascend.com/document/detail/zh/Pytorch/730/configandinstg/instg/docs/zh/installation_guide/installation_via_binary_package.md)进行安装。
