...
参考实现：
- `models/longcat-flash/models/modeling_longcat_flash.py`（搜索 `all_gather_into_tensor` 和 `reduce_scatter_tensor`）
- `models/deepseek_r1/models/modeling_deepseek.py`（搜索同上）
