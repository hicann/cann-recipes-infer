...
- 基于AscendC实现NPU LI和SFA融合Kernel，发挥稀疏计算潜力，AscendC Kernel技术文档和代码已开源在[CANN/ops-transformer仓](https://gitcode.com/cann/ops-transformer)对应算子目录，包含[Lightning Indexer](https://gitcode.com/cann/ops-transformer/tree/master/attention/lightning_indexer)和[Sparse Flash Attention](https://gitcode.com/cann/ops-transformer/tree/master/attention/sparse_flash_attention)等
...
- [DeepSeek-V3.2-Exp vs V3.1](#deepseek-v32-exp-vs-v31)
- [并行策略](#并行策略)
- [MTP](#mtp)
- [融合Kernel](#融合kernel)
- [量化策略](#量化策略)
