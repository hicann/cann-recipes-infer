...
#
# Adapted for Huawei Ascend NPU with torch_npu optimizations.
# Original SAM code: https://github.com/facebookresearch/segment-anything
...
# Ascend NPU: Use scaled_dot_product_attention instead
