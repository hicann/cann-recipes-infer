...
VLLM_MXFP4_ACT_QDQ_SCALE_FACTOR="${VLLM_MXFP4_ACT_QDQ_SCALE_FACTOR:-6.0}"
# KV-cache MXFP4 + Hadamard rotation knobs
VLLM_KV_MXFP4_SKIP="${VLLM_KV_MXFP4_SKIP:-0}"
VLLM_KV_MXFP4_SKIP_QDQ="${VLLM_KV_MXFP4_SKIP_QDQ:-0}"
VLLM_KV_MXFP4_SKIP_ROTATE="${VLLM_KV_MXFP4_SKIP_ROTATE:-0}"
VLLM_KV_MXFP4_ANCHOR="${VLLM_KV_MXFP4_ANCHOR:-32}"
VLLM_KV_MXFP4_GROUP_SIZE="${VLLM_KV_MXFP4_GROUP_SIZE:-32}"
...
export VLLM_MXFP4_ACT_QDQ_SCALE_FACTOR
export VLLM_KV_MXFP4_SKIP
export VLLM_KV_MXFP4_SKIP_QDQ
export VLLM_KV_MXFP4_SKIP_ROTATE
export VLLM_KV_MXFP4_ANCHOR
export VLLM_KV_MXFP4_GROUP_SIZE
...
echo "[INFO] Starting MiniMax-M2.5 MXFP4 W4A4 (+ KV-cache) service"
