...
/*!
 * \file mla_prolog_v3_tiling_check.h
 * \brief
 */

#ifndef MLA_PROLOG_V3_TILING_CHECK_H
#define MLA_PROLOG_V3_TILING_CHECK_H
...
class MlaPrologV3TilingCheck {
public:
    MlaPrologV3TilingCheck(const MlaPrologV3Context &context, const MlaPrologV3BaseShapeInfo &baseShapeInfo,
                         const MlaPrologV3ScenarioInfo &scenarioInfo)
...
private:
    ...
    const MlaPrologV3Context &context_;
    const MlaPrologV3BaseShapeInfo &baseShapeInfo_;
    const MlaPrologV3ScenarioInfo &scenarioInfo_;
