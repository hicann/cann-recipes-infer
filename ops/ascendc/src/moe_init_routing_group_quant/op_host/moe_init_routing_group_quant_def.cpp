...
/*!
 * \file moe_init_routing_group_quant_def.cpp
 * \brief
 */
#include "register/op_def_registry.h"

namespace ops {
class MoeInitRoutingGroupQuant : public OpDef {
public:
    explicit MoeInitRoutingGroupQuant(const char *name) : OpDef(name)
    {
        this->Input("x")
            .ParamType(REQUIRED)
            .DataType({ge::DT_INT8, ge::DT_FLOAT16, ge::DT_BF16, ge::DT_FLOAT, ge::DT_FLOAT16, ge::DT_BF16,
                       ge::DT_FLOAT, ge::DT_FLOAT16, ge::DT_FLOAT16, ge::DT_BF16, ge::DT_BF16, ge::DT_FLOAT,
...
OP_ADD(MoeInitRoutingGroupQuant);
}  // namespace ops