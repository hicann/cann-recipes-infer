 ...
 * \brief
 */
#ifndef MOE_V3_GATHER_FP8_GROUP_QUANT_H_REGBASE
#define MOE_V3_GATHER_FP8_GROUP_QUANT_H_REGBASE
...
public:
    __aicore__ inline MoeGatherOutFp8GroupQuant(){};
...
template <typename T, typename U>
__aicore__ inline void MoeGatherOutFp8GroupQuant<T, U>::Init(GM_ADDR xAddr, GM_ADDR unused_ScaleAddr,
...
template <typename T, typename U>
__aicore__ inline void MoeGatherOutFp8GroupQuant<T, U>::InitKernelTiling(GM_ADDR sortedExpertIdxAddr, const MoeInitRoutingV3Arch35TilingData *tilingData)
{
...
template <typename T, typename U>
__aicore__ inline void MoeGatherOutFp8GroupQuant<T, U>::Process()
{
...
template <typename T, typename U>
__aicore__ inline void MoeGatherOutFp8GroupQuant<T, U>::CopyInExpandedExpertIdx(int64_t progress)
{
...
template <typename T, typename U>
__aicore__ inline void MoeGatherOutFp8GroupQuant<T, U>::CopyExpandedXandMXQuant(int64_t progress)
{
...
template <typename T, typename U>
__aicore__ inline void MoeGatherOutFp8GroupQuant<T, U>::CopyIn(int64_t srcIdx, int64_t colIdx, int64_t loopCols)
{
...
template <typename T, typename U>
__aicore__ inline void MoeGatherOutFp8GroupQuant<T, U>::Compute(uint32_t xElemNum, uint32_t scaleElemNum, uint32_t validScaleElemNum)
{
    // deque input
...
template <typename T, typename U>
__aicore__ inline void MoeGatherOutFp8GroupQuant<T, U>::CopyOut(int64_t dstIdx, int64_t colIdx, int64_t loopCols,
...
template <typename T, typename U>
__aicore__ inline void MoeGatherOutFp8GroupQuant<T, U>::DoGroupQuant(
...
#endif // MOE_V3_GATHER_FP8_GROUP_QUANT_H_REGBASE