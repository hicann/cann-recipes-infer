...
/*!
 * \file dequant_swiglu_clamp_quant_cut_group.h
 * \brief
 */

#ifndef DEQUANT_SWIGLU_CLAMP_QUANT_CUT_GROUP_H
#define DEQUANT_SWIGLU_CLAMP_QUANT_CUT_GROUP_H

#include "kernel_tiling/kernel_tiling.h"
#include "kernel_operator.h"
#include "dequant_swiglu_clamp_quant.h"

namespace DequantSwigluClampQuantGroupOps {
using namespace AscendC;
constexpr static int64_t GROUPINDEX_STRIDE = 2;

TEMPLATE_DSQ_DECLARE
class DequantSwigluClampQuantGroup : public DequantSwigluClampQuantOps::DequantSwigluClampQuantBase<TEMPLATE_DSQ_ARGS> {
 public:
 __aicore__ inline DequantSwigluClampQuantGroup(TPipe* pipe) : DequantSwigluClampQuantOps::DequantSwigluClampQuantBase<TEMPLATE_DSQ_ARGS>(pipe)
  {
    this->pipe_ = pipe;
  };
...
TEMPLATE_DSQ_DECLARE
__aicore__ inline void DequantSwigluClampQuantGroup<TEMPLATE_DSQ_ARGS>::Process() {
...
#endif  // DEQUANT_SWIGLU_CLAMP_QUANT_CUT_GROUP_H