...
/*!
 * \file dequant_swiglu_clamp_quant_dynamic_bias_int32.hpp
 * \brief
 */

#ifndef CANN_DEQUANT_SWIGLU_CLAMP_QUANT_DYNAMIC_BIAS_INT32_HPP
#define CANN_DEQUANT_SWIGLU_CLAMP_QUANT_DYNAMIC_BIAS_INT32_HPP
...
TEMPLATE_DECLARE
class DequantSwigluClampQuantDynamicBiasInt32 : public DequantSwigluClampQuantDynamicBase<TEMPLATE_ARGS>  {
public:
    __aicore__ inline DequantSwigluClampQuantDynamicBiasInt32(){};
    __aicore__ inline ~DequantSwigluClampQuantDynamicBiasInt32(){};
...
TEMPLATE_DECLARE
__aicore__ inline void DequantSwigluClampQuantDynamicBiasInt32<TEMPLATE_ARGS>::Init(
...
TEMPLATE_DECLARE
__aicore__ inline void DequantSwigluClampQuantDynamicBiasInt32<TEMPLATE_ARGS>::Process() {
    this->BaseProcess();
}

TEMPLATE_DECLARE
__aicore__ inline void DequantSwigluClampQuantDynamicBiasInt32<TEMPLATE_ARGS>::InitUbBuffer(uint64_t tileLength,
    uint32_t realRowLen) {
...
#endif  // CANN_DEQUANT_SWIGLU_CLAMP_QUANT_DYNAMIC_BIAS_INT32_HPP