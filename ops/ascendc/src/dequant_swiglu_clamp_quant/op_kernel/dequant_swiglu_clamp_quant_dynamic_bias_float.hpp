...
/*!
 * \file dequant_swiglu_clamp_quant_dynamic_bias_float.hpp
 * \brief
 */

#ifndef CANN_DEQUANT_SWIGLU_CLAMP_QUANT_DYNAMIC_BIAS_FLOAT_HPP
#define CANN_DEQUANT_SWIGLU_CLAMP_QUANT_DYNAMIC_BIAS_FLOAT_HPP
...
class DequantSwigluClampQuantDynamicBiasFloat : public DequantSwigluClampQuantDynamicBase<TEMPLATE_ARGS> {
public:
    __aicore__ inline DequantSwigluClampQuantDynamicBiasFloat(){};
    __aicore__ inline ~DequantSwigluClampQuantDynamicBiasFloat(){};
...
TEMPLATE_DECLARE
__aicore__ inline void DequantSwigluClampQuantDynamicBiasFloat<TEMPLATE_ARGS>::Init(
...
TEMPLATE_DECLARE
__aicore__ inline void DequantSwigluClampQuantDynamicBiasFloat<TEMPLATE_ARGS>::Process() {
    this->BaseProcess();
}

TEMPLATE_DECLARE
__aicore__ inline void DequantSwigluClampQuantDynamicBiasFloat<TEMPLATE_ARGS>::InitUbBuffer(uint64_t tileLength,
    uint32_t realRowLen)
{
...
#endif  // CANN_DEQUANT_SWIGLU_CLAMP_QUANT_DYNAMIC_BIAS_FLOAT_HPP