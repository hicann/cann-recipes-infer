...
/*!
 * \file dequant_swiglu_clamp_quant_static_bias_float.hpp
 * \brief
 */

#ifndef CANN_DEQUANT_SWIGLU_CLAMP_QUANT_STATIC_BIAS_FLOAT_HPP
#define CANN_DEQUANT_SWIGLU_CLAMP_QUANT_STATIC_BIAS_FLOAT_HPP
#include "kernel_operator.h"
#include "dequant_swiglu_clamp_quant_static_base.hpp"
namespace DequantSwigluClampQuant {

using namespace AscendC;

TEMPLATE_DECLARE_STATIC
class DequantSwigluClampQuantStaticBiasFloat : public DequantSwigluClampQuantStaticBase<TEMPLATE_ARGS_STATIC> {
public:
    __aicore__ inline DequantSwigluClampQuantStaticBiasFloat() {}
    __aicore__ inline ~DequantSwigluClampQuantStaticBiasFloat() {}
    ...
    __aicore__ inline void Init(GM_ADDR x_gm, GM_ADDR weight_scale_gm, GM_ADDR activation_scale_gm, GM_ADDR bias_gm,
        ...
        const DequantSwigluClampQuantTilingData* tilingData, TPipe* pipe_);
...
TEMPLATE_DECLARE_STATIC
__aicore__ inline void DequantSwigluClampQuantStaticBiasFloat<TEMPLATE_ARGS_STATIC>::Init(GM_ADDR x_gm, GM_ADDR weight_scale_gm,
    GM_ADDR activation_scale_gm, GM_ADDR bias_gm, GM_ADDR quant_scale_gm, GM_ADDR quant_offset_gm,
    GM_ADDR y_gm, GM_ADDR scale_gm, const DequantSwigluClampQuantTilingData* tilingData, TPipe* pipe_)
{
    this->pipe = pipe_;
...
TEMPLATE_DECLARE_STATIC
__aicore__ inline void DequantSwigluClampQuantStaticBiasFloat<TEMPLATE_ARGS_STATIC>::Process()
{
...
TEMPLATE_DECLARE_STATIC
__aicore__ inline void DequantSwigluClampQuantStaticBiasFloat<TEMPLATE_ARGS_STATIC>::InitUbBuffer()
{
...
} // using namespace DequantSwigluClampQuant

#endif  // CANN_DEQUANT_SWIGLU_CLAMP_QUANT_STATIC_BIAS_FLOAT_HPP