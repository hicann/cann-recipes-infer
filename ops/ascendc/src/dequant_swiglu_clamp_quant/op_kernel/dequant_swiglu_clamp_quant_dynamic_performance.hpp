...
/*!
 * \file dequant_swiglu_clamp_quant_dynamic_performance.hpp
 * \brief
 */

#ifndef DEQUANT_SWIGLU_CLAMP_QUANT_DYNAMIC_PERFORMANCE_HPP
#define DEQUANT_SWIGLU_CLAMP_QUANT_DYNAMIC_PERFORMANCE_HPP

#include "kernel_operator.h"
#include "dequant_swiglu_clamp_quant_dynamic_base.hpp"

namespace DequantSwigluClampQuant {
using namespace AscendC;

TEMPLATE_DECLARE
class DequantSwigluClampQuantDynamicPerformance : public DequantSwigluClampQuantDynamicBiasFloat<TEMPLATE_ARGS> {
public:
    __aicore__ inline DequantSwigluClampQuantDynamicPerformance(){};
    __aicore__ inline ~DequantSwigluClampQuantDynamicPerformance(){};
    ...
    GM_ADDR userspace, const DequantSwigluClampQuantTilingData* tilingData, TPipe* pipe_);
...
TEMPLATE_DECLARE
__aicore__ inline void DequantSwigluClampQuantDynamicPerformance<TEMPLATE_ARGS>::Init(
    GM_ADDR x_gm, GM_ADDR weight_scale_gm, GM_ADDR activation_scale_gm, GM_ADDR bias_gm, GM_ADDR quant_scale_gm,
    GM_ADDR quant_offset_gm, GM_ADDR y_gm, GM_ADDR scale_gm, GM_ADDR userspace, const DequantSwigluClampQuantTilingData* tilingData,
    TPipe* pipe_)
{
...
TEMPLATE_DECLARE
__aicore__ inline void DequantSwigluClampQuantDynamicPerformance<TEMPLATE_ARGS>::InitCommon(GM_ADDR x_gm, GM_ADDR weight_scale_gm, GM_ADDR activation_scale_gm, GM_ADDR bias_gm,
    GM_ADDR quant_scale_gm, GM_ADDR quant_offset_gm, GM_ADDR y_gm, GM_ADDR scale_gm,
    GM_ADDR userspace, const DequantSwigluClampQuantTilingData* tilingData, TPipe* pipe_)
{
    this->pipe = pipe_;
...
TEMPLATE_DECLARE
__aicore__ inline void DequantSwigluClampQuantDynamicPerformance<TEMPLATE_ARGS>::InitUbBufferCommon(uint64_t tileLength, uint32_t realRowLen)
{
...
TEMPLATE_DECLARE
__aicore__ inline void DequantSwigluClampQuantDynamicPerformance<TEMPLATE_ARGS>::Process() {
...
TEMPLATE_DECLARE
__aicore__ inline void DequantSwigluClampQuantDynamicPerformance<TEMPLATE_ARGS>::CopyOutScale(uint32_t realRowLen)
{
...
TEMPLATE_DECLARE
__aicore__ inline void DequantSwigluClampQuantDynamicPerformance<TEMPLATE_ARGS>::CanFullLocaOneRow(uint32_t offset1, uint32_t offset2)
{
...
TEMPLATE_DECLARE
__aicore__ inline void DequantSwigluClampQuantDynamicPerformance<TEMPLATE_ARGS>::CopyInQuantScale(uint64_t dataTileLength, uint64_t offset)
{
...
TEMPLATE_DECLARE
__aicore__ inline void DequantSwigluClampQuantDynamicPerformance<TEMPLATE_ARGS>::CopyInDequantBuffer(uint32_t offset1, uint32_t offset2, uint32_t dataTileLen)
{
...
TEMPLATE_DECLARE
__aicore__ inline void DequantSwigluClampQuantDynamicPerformance<TEMPLATE_ARGS>::CopyIn(uint32_t dataTileLen, uint32_t offset1, uint32_t offset2, uint32_t blockCount, int32_t ppFlag)
{
...
TEMPLATE_DECLARE
__aicore__ inline void DequantSwigluClampQuantDynamicPerformance<TEMPLATE_ARGS>::BaseCompute1(uint64_t curTileLen, uint64_t blockCount, uint64_t rowId, int32_t ppFlag)
{
...
TEMPLATE_DECLARE
__aicore__ inline void DequantSwigluClampQuantDynamicPerformance<TEMPLATE_ARGS>::BaseCompute2(uint64_t curTileLen, uint64_t blockCount, uint64_t rowId, int32_t ppFlag)
{
...
TEMPLATE_DECLARE
__aicore__ inline void DequantSwigluClampQuantDynamicPerformance<TEMPLATE_ARGS>::CopyOutF(uint64_t rowId, uint64_t tileLen, uint64_t length, int32_t ppFlag)
{
    LocalTensor<int8_t> outLocal = ppFlag ? outFLocalPong : outFLocalPing;
...
#endif  // DEQUANT_SWIGLU_CLAMP_QUANT_DYNAMIC_PERFORMANCE_HPP