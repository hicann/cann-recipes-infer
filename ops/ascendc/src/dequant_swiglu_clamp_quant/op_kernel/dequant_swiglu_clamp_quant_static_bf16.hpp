...
/*!
 * \file dequant_swiglu_clamp_quant_static_bf16.hpp
 * \brief
 */

#ifndef CANN_DEQUANT_SWIGLU_CLAMP_QUANT_STATIC_BF16_HPP
#define CANN_DEQUANT_SWIGLU_CLAMP_QUANT_STATIC_BF16_HPP
...
class DequantSwigluClampQuantStaticBF16 : public DequantSwigluClampQuantStaticBase<TEMPLATE_ARGS_STATIC> {
public:
    __aicore__ inline DequantSwigluClampQuantStaticBF16() {}
    __aicore__ inline ~DequantSwigluClampQuantStaticBF16() {}
...
TEMPLATE_DECLARE_STATIC
__aicore__ inline void DequantSwigluClampQuantStaticBF16<TEMPLATE_ARGS_STATIC>::Init(GM_ADDR x_gm, GM_ADDR weight_scale_gm,
...
TEMPLATE_DECLARE_STATIC
__aicore__ inline void DequantSwigluClampQuantStaticBF16<TEMPLATE_ARGS_STATIC>::Process()
{
...
TEMPLATE_DECLARE_STATIC
__aicore__ inline void DequantSwigluClampQuantStaticBF16<TEMPLATE_ARGS_STATIC>::convertFloat(uint64_t tileLen, uint64_t i)
{
...
#endif  // CANN_DEQUANT_SWIGLU_CLAMP_QUANT_STATIC_BF16_HPP