...
/*!
 * \file dequant_swiglu_clamp_quant_static_base.hpp
 * \brief
 */

#ifndef CANN_DEQUANT_SWIGLU_CLAMP_QUANT_STATIC_BASE_HPP
#define CANN_DEQUANT_SWIGLU_CLAMP_QUANT_STATIC_BASE_HPP
...
class DequantSwigluClampQuantStaticBase {
public:
    __aicore__ inline DequantSwigluClampQuantStaticBase() {}
    __aicore__ inline ~DequantSwigluClampQuantStaticBase() {}
...
#endif  // CANN_DEQUANT_SWIGLU_CLAMP_QUANT_STATIC_BASE_HPP