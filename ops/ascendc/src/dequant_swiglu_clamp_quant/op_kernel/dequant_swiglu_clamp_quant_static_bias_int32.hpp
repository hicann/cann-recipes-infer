...
/*!
 * \file dequant_swiglu_clamp_quant_static_bias_int32.hpp
 * \brief
 */

#ifndef CANN_DEQUANT_SWIGLU_CLAMP_QUANT_STATIC_BIAS_INT32_HPP
#define CANN_DEQUANT_SWIGLU_CLAMP_QUANT_STATIC_BIAS_INT32_HPP
...
class DequantSwigluClampQuantStaticBiasInt32 : public DequantSwigluClampQuantStaticBase<TEMPLATE_ARGS_STATIC> {
public:
    __aicore__ inline DequantSwigluClampQuantStaticBiasInt32() {}
    __aicore__ inline ~DequantSwigluClampQuantStaticBiasInt32() {}
...
TEMPLATE_DECLARE_STATIC
__aicore__ inline void DequantSwigluClampQuantStaticBiasInt32<TEMPLATE_ARGS_STATIC>::Init(GM_ADDR x_gm, GM_ADDR weight_scale_gm,
...
TEMPLATE_DECLARE_STATIC
__aicore__ inline void DequantSwigluClampQuantStaticBiasInt32<TEMPLATE_ARGS_STATIC>::Process()
{
...
TEMPLATE_DECLARE_STATIC
__aicore__ inline void DequantSwigluClampQuantStaticBiasInt32<TEMPLATE_ARGS_STATIC>::InitUbBuffer()
{
...
#endif  // CANN_DEQUANT_SWIGLU_CLAMP_QUANT_STATIC_BIAS_INT32_HPP