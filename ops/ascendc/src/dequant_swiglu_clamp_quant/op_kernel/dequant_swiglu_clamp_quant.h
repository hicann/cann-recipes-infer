...
/*!
 * \file dequant_swiglu_clamp_quant.h
 * \brief
 */

#ifndef DEQUANT_SWIGLU_CLAMP_QUANT_H
#define DEQUANT_SWIGLU_CLAMP_QUANT_H
...
namespace DequantSwigluClampQuantOps {
...
class DequantSwigluClampQuantBase
{
public:
    static constexpr bool hasGroupIndex_ = !IsSameType<TGroup, float>::value;
    __aicore__ inline DequantSwigluClampQuantBase(TPipe* pipe)
    {
        pipe_ = pipe;
    };
    ...
    __aicore__ inline void Init(
        ...
        GM_ADDR groupIndex, GM_ADDR y, GM_ADDR scale, const DequantSwigluClampQuantTilingData* tilingData);
...
protected:
    ...
    const DequantSwigluClampQuantTilingData* tl_ = nullptr;
};
// 公共函数实现

TEMPLATE_DSQ_DECLARE
__aicore__ inline void DequantSwigluClampQuantBase<TEMPLATE_DSQ_ARGS>::Init(
    GM_ADDR x, GM_ADDR weightScale, GM_ADDR activationScale, GM_ADDR bias, GM_ADDR quantScale, GM_ADDR quantOffset,
    GM_ADDR groupIndex, GM_ADDR y, GM_ADDR scale, const DequantSwigluClampQuantTilingData* tilingData)
{
    tl_ = tilingData;
...
TEMPLATE_DSQ_DECLARE
__aicore__ inline void DequantSwigluClampQuantBase<TEMPLATE_DSQ_ARGS>::Process()
{
    if constexpr (!hasGroupIndex_) {
...
TEMPLATE_DSQ_DECLARE
__aicore__ inline void DequantSwigluClampQuantBase<TEMPLATE_DSQ_ARGS>::ProcessSingleGroup(
...
TEMPLATE_DSQ_DECLARE
__aicore__ inline void DequantSwigluClampQuantBase<TEMPLATE_DSQ_ARGS>::CopyInWeightScale(int64_t groupIdx)
{
...
TEMPLATE_DSQ_DECLARE
__aicore__ inline void DequantSwigluClampQuantBase<TEMPLATE_DSQ_ARGS>::CopyInQuantScale(int64_t groupIdx)
{
    DataCopyPadParams padParams{false, 0, 0, 0};
...
TEMPLATE_DSQ_DECLARE
__aicore__ inline void DequantSwigluClampQuantBase<TEMPLATE_DSQ_ARGS>::CopyInBias(int64_t groupIdx)
{
    DataCopyPadParams padParams{false, 0, 0, 0};
    if constexpr (std::is_same_v<TXGm, int32_t>) {
        if (tl_->hasBias == 1) {
...
TEMPLATE_DSQ_DECLARE
__aicore__ inline void DequantSwigluClampQuantBase<TEMPLATE_DSQ_ARGS>::CopyInXAct(int32_t proDimsx, int64_t xDimxOffset)
{
...
TEMPLATE_DSQ_DECLARE
__aicore__ inline void DequantSwigluClampQuantBase<TEMPLATE_DSQ_ARGS>::ComputeDequant(int32_t proDimsx)
{
...
TEMPLATE_DSQ_DECLARE
__aicore__ inline void DequantSwigluClampQuantBase<TEMPLATE_DSQ_ARGS>::ComputeSwiGLU(int32_t proDimsx)
{
...
TEMPLATE_DSQ_DECLARE
__aicore__ inline void DequantSwigluClampQuantBase<TEMPLATE_DSQ_ARGS>::ComputeQuant(int32_t proDimsx)
{
    LocalTensor<float> tmpUbF32 = tmpBuf1_.AllocTensor<float>();
    LocalTensor<float> tmpUbF32Act = tmpUbF32;
...
TEMPLATE_DSQ_DECLARE
__aicore__ inline void DequantSwigluClampQuantBase<TEMPLATE_DSQ_ARGS>::Compute(int32_t proDimsx)
{
...
TEMPLATE_DSQ_DECLARE
__aicore__ inline void DequantSwigluClampQuantBase<TEMPLATE_DSQ_ARGS>::CopyOut(int32_t proDimsx, int64_t xDimxOffset)
{
    // copy out
...
TEMPLATE_DSQ_DECLARE
__aicore__ inline void DequantSwigluClampQuantBase<TEMPLATE_DSQ_ARGS>::ParamDequeAndCast()
{
...
TEMPLATE_DSQ_DECLARE
__aicore__ inline void DequantSwigluClampQuantBase<TEMPLATE_DSQ_ARGS>::ProcessSingleGroupPerCore(
...
TEMPLATE_DSQ_DECLARE
__aicore__ inline void DequantSwigluClampQuantBase<TEMPLATE_DSQ_ARGS>::ParamFree()
{
...
TEMPLATE_DSQ_DECLARE
__aicore__ inline void DequantSwigluClampQuantBase<TEMPLATE_DSQ_ARGS>::ComputeReduceMax(
...
TEMPLATE_DSQ_DECLARE
__aicore__ inline void DequantSwigluClampQuantBase<TEMPLATE_DSQ_ARGS>::CreateOffsetLocalTensor(
...
TEMPLATE_DSQ_DECLARE
__aicore__ inline void DequantSwigluClampQuantBase<TEMPLATE_DSQ_ARGS>::SwiGluGate(
    int32_t proDimsx, const LocalTensor<float>& xLocalF32, const LocalTensor<uint32_t>& xOffsetLocalU32)
{
    uint32_t calEleNum = tl_->UbFactorDimy * proDimsx;
    LocalTensor<float> tmpUbF32 = tmpBuf1_.AllocTensor<float>();
...
TEMPLATE_DSQ_DECLARE
__aicore__ inline void DequantSwigluClampQuantBase<TEMPLATE_DSQ_ARGS>::DynamicQuant(
    const LocalTensor<float>& tmpUbF32Act, const LocalTensor<float>& tmpUbF32Gate,
    const LocalTensor<float>& inScaleLocal, uint32_t proDimsx)
{
...
TEMPLATE_DSQ_DECLARE
__aicore__ inline void DequantSwigluClampQuantBase<TEMPLATE_DSQ_ARGS>::StaticQuant(
    const LocalTensor<float>& tmpUbF32Act, const LocalTensor<float>& tmpUbF32Gate,
    const LocalTensor<float>& inScaleLocal, uint32_t proDimsx)
{
    if (tl_->needSmoothScale == 1) {
...
TEMPLATE_DSQ_DECLARE
__aicore__ inline void DequantSwigluClampQuantBase<TEMPLATE_DSQ_ARGS>::CastFloatToInt8(
    const LocalTensor<float>& tmpUbF32Act, const LocalTensor<float>& tmpUbF32Gate, uint32_t proDimsx, LocalTensor<int8_t>& yOut)
{
...
TEMPLATE_DSQ_DECLARE
template<typename T>
__aicore__ inline void DequantSwigluClampQuantBase<TEMPLATE_DSQ_ARGS>::CopyReshape(
...
#endif // DEQUANT_SWIGLU_CLAMP_QUANT_H