...
BEGIN_TILING_DATA_DEF(QuantRopeRegbaseTilingData)
...
REGISTER_TILING_DATA_CLASS(PartialRotaryMulQuant, QuantRopeRegbaseTilingData)

ge::graphStatus Tiling4PartialRotaryMulQuant(gert::TilingContext* context);
struct QuantRotaryPositionEmbeddingCompileInfo {
    int64_t blockDim;
    uint64_t ubSize;
    platform_ascendc::SocVersion socVersion;
};

struct QuantAiCoreParams {
    uint64_t ubSize = 0;
    uint64_t blockDim = 0;
    uint64_t aicNum = 0;
    uint64_t l1Size = 0;
...
class QuantRopeRegBaseTilingClass {
public:
    explicit QuantRopeRegBaseTilingClass(gert::TilingContext *context) : context_(context)
    {
    }

    void Reset(gert::TilingContext *context)
    {
        QuantRopeRegBaseTilingClass::Reset(context);
    }
...
protected:
    ...
    QuantAiCoreParams aicoreParams_;
    int64_t sliceStart_{0};
    int64_t sliceEnd_{0};
    int64_t sliceLength_{0};
    int64_t cosd_{0};
    int64_t sind_{0};
    float scaleAttr_ = 1.0f;
};

class QuantRopeRegBaseTilingClassAAndB : public QuantRopeRegBaseTilingClass {
public:
    explicit QuantRopeRegBaseTilingClassAAndB(gert::TilingContext *context) : QuantRopeRegBaseTilingClass(context)
    {
    }
...
private:
    ...
    QuantRopeRegbaseTilingData tilingData_;
};

class QuantRopeRegBaseTilingClassAB : public QuantRopeRegBaseTilingClass {
public:
    explicit QuantRopeRegBaseTilingClassAB(gert::TilingContext *context) : QuantRopeRegBaseTilingClass(context)
    {
    }
...
class QuantRopeRegBaseTilingClassABAAndBA : public QuantRopeRegBaseTilingClass {
public:
    explicit QuantRopeRegBaseTilingClassABAAndBA(gert::TilingContext *context) : QuantRopeRegBaseTilingClass(context)
    {
    }
...
class QuantRopeRegBaseTilingClassBAB : public QuantRopeRegBaseTilingClass {
public:
    explicit QuantRopeRegBaseTilingClassBAB(gert::TilingContext *context_) : QuantRopeRegBaseTilingClass(context_)
    {
    }
