...
/*!
 * \file rotate_interleaved_split_bsn_mixed.h
 * \brief
 */
#ifndef ROTATE_INTERLEAVED_SPLIT_BSN_MIXED_H
#define ROTATE_INTERLEAVED_SPLIT_BSN_MIXED_H
...
template <typename T>
__aicore__ inline void InterleavedSplitBSNMixed<T>::InitData(const RopeRegbaseTilingData *tiling)
{
    tiling_ = tiling;
...
#endif // ROTATE_INTERLEAVED_SPLIT_BSN_MIXED_H
