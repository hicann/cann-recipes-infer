...
/*!
 * \file rotate_interleaved_split_bs_mixed.h
 * \brief
 */
#ifndef ROTATE_INTERLEAVED_SPLIT_BS_MIXED_H
#define ROTATE_INTERLEAVED_SPLIT_BS_MIXED_H
...
template <typename T>
__aicore__ inline void InterleavedSplitBSMixed<T>::InitData(const RopeRegbaseTilingData *tiling)
{
    tiling_ = tiling;
...
#endif // ROTATE_INTERLEAVED_SPLIT_BS_MIXED_H
