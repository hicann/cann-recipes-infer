...
 */
    ...
    {
        m.impl("npu_kv_quant_sparse_attn_sharedkv", &custom::npu_kv_quant_sparse_attn_sharedkv_npu);
    }
    
    // step5, 为META设备注册前向实现
    TORCH_LIBRARY_IMPL(custom, Meta, m)
    {
        m.impl("npu_kv_quant_sparse_attn_sharedkv", &custom::npu_kv_quant_sparse_attn_sharedkv_meta);
    }