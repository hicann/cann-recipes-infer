...
@register_fx_node_ge_converter(torch.ops.custom.npu_quant_sparse_flash_mla.default)
def convert_npu_quant_sparse_flash_mla(
    q: Tensor,
    qkv_quant_mode: int,
    *,
    ...
    ori_kv_descale: Optional[Tensor] = None,
    cmp_kv_descale: Optional[Tensor] = None,
    ...
    attrs={"qkv_quant_mode": attr.Int(qkv_quant_mode),
            ...
            "topk_value_mode": attr.Int(topk_value_mode),
