...
@register_fx_node_ge_converter(torch.ops.custom.npu_swiglu_clip_quant.default)
def convert_npu_swiglu_clip_quant(
    x: Tensor,
    group_index: Tensor,
    group_alpha: Tensor,
    *,
    ...
    return torchair.ge.custom_op(
        ...
        attrs={"activate_left": attr.Bool(activate_left),
